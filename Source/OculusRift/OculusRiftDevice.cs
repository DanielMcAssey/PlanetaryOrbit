...
namespace OculusRift.Oculus
{
    ...
    internal class OculusRiftDevice
    {
        ...
        public static bool GetScreenResolution(ref int hResolution, ref int vResolution)
        {
            int h = 0;
            int v = 0;
            if (OVR_GetScreenResolution(ref h, ref v))
            {
                hResolution = h;
                vResolution = v;
                return true;
        ...
        public static bool GetScreenSize(ref float hSize, ref float vSize)
        {
            float h = 0;
            float v = 0;
            if (OVR_GetScreenSize(ref h, ref v))
            {
                hSize = h;
                vSize = v;
                return true;
        ...
        public static bool GetEyeToScreenDistance(ref float eyeToScreenDistance)
        {
            float d = 0;
            if(OVR_GetEyeToScreenDistance(ref d))
            {
                eyeToScreenDistance = d;
                return true;
            }
            return false;
        }

        public static bool GetLensSeparationDistance(ref float lensSeparationDistance)
        {
            float d = 0;
            if (OVR_GetLensSeparationDistance(ref d))
            {
                lensSeparationDistance = d;
                return true;
            }
            return false;
        }

        public static bool GetInterpupillaryDistance(ref float interPupillaryDistance)
        {
            float d = 0;
            if (OVR_GetInterpupillaryDistance(ref d))
            {
                interPupillaryDistance = d;
                return true;
            }
            return false;
        }
        ...
        {
            if (OVR_ResetSensorOrientation(sensorID))
            {
                return true;
            }
            return false;
        ...
        {
            if (OVR_SetSensorPredictionTime(sensorID, predictionTime))
            {
                return true;
            }
            return false;
