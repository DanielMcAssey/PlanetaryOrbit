...
namespace SquidXNA
{
    public class RendererXNA : Squid.ISquidRenderer
    {
        ...
        public RendererXNA(Game game)
        {
            ...
            FontTypes.Add(Squid.Font.Default, new Squid.Font { Name = "System/UI/Fonts/Arial10", Family = "Arial", Size = 11, Bold = true, International = true });
        ...
        public int GetTexture(string name)
        {
            ...
            Texture2D texture = Game.Content.Load<Texture2D>(Path.ChangeExtension(name, null));
            TextureIndex++;
        ...
        public int GetFont(string name)
        {
            ...
            SpriteFont font = Game.Content.Load<SpriteFont>(type.Name);
            FontIndex++;
