...
namespace PlanetaryOrbit.Core.Screen
{
    class ScreenLoading : BaseScreen
    {
        ...
        {
            Load(pmanager, GameSettings.ASSET_CONFIG_MSG_LOADING, pisdisplayed, pcontrollingplayer, pnewscreens);
        }
        ...
        protected AdvancedModel mModel;
        protected CameraChase mCamera;
        ...
        private ScreenLoading(ScreenManager pmanager, String pmessage, bool pisdisplayed, BaseScreen[] pnewscreens)
        {
            ...
            this.mModel = new AdvancedModel(pmanager.ContentManager.Load<Model>("Core/Models/BaseObject/High/model"), Vector3.Zero, Vector3.Zero, new Vector3(1, 1, 1));
            this.mModel.AddTexture(enumTextureType.MAP_COLOUR, pmanager.ContentManager.Load<Texture2D>("Core/Textures/Earth/colour"));
            this.mModel.AddTexture(enumTextureType.MAP_NORMAL, pmanager.ContentManager.Load<Texture2D>("Core/Textures/Earth/normal"));
            this.mModel.AddTexture(enumTextureType.MAP_SPECULAR, pmanager.ContentManager.Load<Texture2D>("Core/Textures/Earth/specular"));
            this.mModel.AddTexture(enumTextureType.MAP_LIGHTS, pmanager.ContentManager.Load<Texture2D>("Core/Textures/Earth/lights"));
            this.mModel.AddTexture(enumTextureType.MAP_CLOUD, pmanager.ContentManager.Load<Texture2D>("Core/Textures/Earth/cloud"));
            this.mModel.AddTexture(enumTextureType.MAP_WATER, pmanager.ContentManager.Load<Texture2D>("Core/Textures/Earth/water"));
            this.mModel.AddTexture(enumTextureType.LAYER_SPECIAL1, pmanager.ContentManager.Load<Texture2D>("Core/Textures/Earth/atmosphere"));
            this.mModel.AddShader("Main", enumShaderType.EARTH, pmanager.ContentManager.Load<Effect>("Core/Shaders/Special/Earth"));
            this.mModel.LightDirection = new Vector3(0f, 0f, 1f);

            this.mCamera = new CameraChase(pmanager.GraphicsDevice, pmanager.InputManager);
        ...
        {
            this.mModel.UpdateModel(this.ScreenManager.Timer.TotalGameTime);
            this.mCamera.Update(this.ScreenManager.Timer.ElapsedGameTime, this.mModel.World);
        }
        ...
        public override void render()
        {
            ...
            this.mModel.DrawModel(this.mCamera, true);
