    ...
    public abstract class BaseGUIScreen : BaseScreen
    {
        ...
        public override void loadContent()
        {
            if (this._content == null)
                this._content = new ContentManager(ScreenManager.Game.Services, GameSettings.CONFIG_CONTENT_ROOT);
...
#if WINDOWS
            this._menu_supportIcons.Add("GO", this._content.Load<Texture2D>("System/UI/Controls/Keyboard/enter"));
            this._menu_supportIcons.Add("BACK", this._content.Load<Texture2D>("System/UI/Controls/Keyboard/esc"));
#else
            this._menu_supportIcons.Add("GO", this._content.Load<Texture2D>("System/UI/Controls/Gamepad/xboxControllerButtonA"));
            this._menu_supportIcons.Add("BACK", this._content.Load<Texture2D>("System/UI/Controls/Gamepad/xboxControllerButtonB"));
#endif
