...
namespace PlanetaryOrbit.Core.Screen
{
    public class MenuItemBasic
    {
        ...
        public static readonly Color DEF_COLOUR_SELECTED = new Color(51, 142, 255);
        ...
        /// </summary>
        public MenuItemBasic(string pitemtext, ContentManager _content)
            : this(pitemtext, DEF_COLOUR_NORMAL, DEF_COLOUR_SELECTED, _content)
        {
